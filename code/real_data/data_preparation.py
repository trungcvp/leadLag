...
from code.real_data.data_preparation_utils import get_data, transform_sic, filter_by_na_and_volume, calculate_market_beta, \
    remove_market_return

#%% LOADING DATA

directory = '/home/trungnguyen21/Desktop/mlj-lead-lag-main/data/data1006ver2.csv'
